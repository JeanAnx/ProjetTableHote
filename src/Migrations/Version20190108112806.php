 ...
 */
final class Version20190108112806 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE hours (id INT AUTO_INCREMENT NOT NULL, host_table_id INT NOT NULL, day VARCHAR(25) NOT NULL, morning_start TIME NOT NULL, morning_end TIME NOT NULL, evening_start TIME NOT NULL, evening_end TIME NOT NULL, INDEX IDX_8A1ABD8DBD16D44A (host_table_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
